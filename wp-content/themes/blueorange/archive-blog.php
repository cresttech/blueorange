...
<section class="insight_sec blog_sec wi_full py_3 pt-0">
    <div class="container">
         <div class="sec_title"><h2>Blogs</h2></div>
               ...
               <div class="row">
                  <div class="col-12 col-sm-6 col-lg-3">
                     <div class="blog_search form-group">
                        ...
                        <input type="hidden" value="blog_tags" name="tag_name" />
                        <input type="hidden" value="technology_tags" name="tag_names" />
                        <input type="hidden" value="industries_tags" name="indtag_name" />
