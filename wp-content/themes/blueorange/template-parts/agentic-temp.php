...
<section class="workshop_sec wi_full">
    <div class="container-xxl">
        <div class="row align-items-center" data-aos="fade-up" data-aos-duration="1500">
            <div class="col-lg-3 title_col light_grey">
...
<section class="b_service_sec databricke_tabs wi_full py_3 d-none" id="strategySection">
    <div class="container-xxl">
...
<section class="casestudy_sec wi_full py_3 d-none">
    <div class="container-xxl">
        <div class="row align-items-end" data-aos="fade-up" data-aos-duration="1500">
