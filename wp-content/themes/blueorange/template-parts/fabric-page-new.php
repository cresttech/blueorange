<?php
/*
Template Name: Microsoft Fabric Page
*/
get_header();
?>
...
<section class="data_services wi_full py_3">
    <div class="container-xxl">
        ...
        <img src="<?php the_field('image_2'); ?>" class="w-100 mt-4 mb-4" data-aos="fade-up" data-aos-duration="2000">
        <div class="row gmnt_capabilities mt_3" data-aos="fade-up" data-aos-duration="2500">
			<?php if( have_rows('content_6') ):
			while ( have_rows('content_6') ) : the_row();	?>
            <div class="col-lg-6 mt-3">
                <div class="content_wrap light_grey">
                    <h2 class="text_color text-uppercase"><?php the_sub_field('title'); ?></h2>
                    <?php the_sub_field('text'); ?>
                    <img src="<?php the_sub_field('image'); ?>" class="w-100 mt-3">
                </div>
            </div>
			<?php endwhile; endif;?>
        </div>
...
<section class="data_services wi_full py_3">
    <div class="container-xxl">
        ...
        <img src="<?php the_field('image_4'); ?>" class="w-100 mt-4 mb-4" data-aos="fade-up" data-aos-duration="2000">
    </div>
</section>
    ...
    <div class="container-xxl">
        <div class="row" data-aos="fade-up" data-aos-duration="1500">
            <div class="col-lg-6 title_col">
                ...
                <h2 class="text-uppercase text_color mb-lg-0"><?php the_field('heading_7'); ?></h2>
            </div>
...
<section class="b_service_sec msfabric_tabs wi_full py_3" id="strategySection">
    <div class="container-xxl">
        <div class="row align-items-end" data-aos="fade-up" data-aos-duration="1500">
            <div class="col-lg-5 title_col">
