        ...
        <div class="row">
            <div class="col-lg-7 col-md-10 mx-auto">
                <div class="sec_title text-center mb-0 light_grey">
                    ...
                    <div class="btn_block justify-content-center">
                        <a href="<?php the_field('button_link'); ?>" class="button blue_btn" target="_blank"><?php the_field('button_text'); ?> <i class="fa-solid fa-angle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
