...
while ( have_posts() ) :
   ...
   get_template_part( 'template-parts/content/content-insights' );
endwhile; // End of the loop.
?>

<section class="insight_sec related_post wi_full py_3 d-none">
    <div class="container-xxl">
      <div class="sec_title btn_title mb-0">
          <h2>Explore more Blog Posts</h2>
          <a href="<?php echo site_url(); ?>/blog/" class="button orange_btn v_dsktop">Read All</a>
        </div>
